                                ...
                                >
                                    ...
                                    <form className="space-y-4 mt-6">
                                        ...
                                        <div className="flex justify-center">
                                            <button
                                                type="submit"
                                                className="text-white font-bold py-2 px-4 rounded-md shadow-md hover:shadow-lg transform hover:scale-105 transition duration-300 text-sm bg-blue-800 hover:bg-blue-600"
                                            >
                                                SEND
                                            </button>
                                        </div>
